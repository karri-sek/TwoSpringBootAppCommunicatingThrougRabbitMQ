...
public class SpringBootRabbitMQApplication implements RabbitListenerConfigurer {
    ...
    public static final String EXCHANGE_NAME = "britishgas.exchange";
    public static final String QUEUE_SPECIFIC_NAME = "britishgas.queue";
    public static final String ROUTING_KEY = "britishgas.routingkey";
